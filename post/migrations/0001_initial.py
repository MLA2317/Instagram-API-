    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='account.following')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users_id', models.ManyToManyField(to='account.following')),
            ],
        ),
        migrations.CreateModel(
            name='Like',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_liek_follower', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='comment',
